  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4 lg:p-7">
      ...
      <div className="relative z-10 pl-5">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Deactive Sellers</h1>
          <p className="text-gray-600">Manage and view all deactive sellers</p>
        </div>
            ...
            <div className="overflow-x-auto">
                  ...
                  {sellers.map((d, i) => (
                    <tr key={i} className="hover:bg-gray-50/50 transition-all duration-200">
                      <td className="py-4 px-4 font-medium text-gray-900">
                        <div className="w-8 h-8 bg-red-100/80 text-red-800 rounded-lg flex items-center justify-center text-sm font-semibold">
                          {i + 1}
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4">
                        <span className="inline-flex px-3 py-1 rounded-full text-xs font-medium bg-red-100/80 text-red-800 border border-red-200/50">
                          {d.status}
                        </span>
                      </td>
                      <td className="py-4 px-4 font-medium text-gray-700">
              ...
              {sellers.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">No Deactive Sellers Found</h3>
